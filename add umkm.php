...
if (isset($_POST['submit'])) {
      ...
      if($check !== false) {
          if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif" ) {
              ...
              if (move_uploaded_file($_FILES["gambar"]["tmp_name"], $target_file)) {
                  $message = "Gambar ". htmlspecialchars( basename( $_FILES["gambar"]["name"])). " berhasil diunggah.";
              } else {
  ...
  $query = "INSERT INTO umkm (nama, deskripsi, gambar) VALUES ('$nama', '$deskripsi', '$gambar_nama')";
...
<head>
  ...
  <title>Tambah UMKM - Admin Desa Klero</title>
          ...
          <form method="POST" enctype="multipart/form-data" id="umkmForm">
            ...
            <div class="form-group">
              ...
              <textarea id="deskripsi" name="deskripsi" class="form-control" 
                        placeholder="Deskripsikan produk dan keunggulan UMKM..." required></textarea>
              <div class="form-text">
